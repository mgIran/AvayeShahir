...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/svg.css?5');
    $cs->registerCssFile($baseUrl.'/css/bootstrap-theme.css?5');
    ...
    if (Yii::app()->params['default_language'] !== Yii::app()->language)
    {
        ...
        $cs->registerCssFile($baseUrl.'/css/bootstrap-theme-'.Yii::app()->language.'.css?5');
    }
    ...
    $cs->registerScriptFile($baseUrl.'/js/scripts.js?5');
    ?>
</head>
