...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/svg.css?4.3');
    ...
    if (Yii::app()->params['default_language'] !== Yii::app()->language)
    {
        ...
        $cs->registerCssFile($baseUrl.'/css/bootstrap-theme-'.Yii::app()->language.'.css?4.3');
    }

    $cs->registerScriptFile($baseUrl.'/js/bootstrap.min.js');
    $cs->registerScriptFile($baseUrl.'/js/material.min.js');
    $cs->registerScriptFile($baseUrl.'/js/ripples.min.js');
    $cs->registerScriptFile($baseUrl.'/js/scripts.js?4.3');
    ?>
</head>
