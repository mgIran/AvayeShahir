...
<head>
    ...
    $cs->registerCssFile($baseUrl.'/css/bootstrap-theme.css?10.3');
    if (Yii::app()->params['default_language'] !== Yii::app()->language)
    {
        // @todo add css for multi language
        $cs->registerCssFile($baseUrl.'/css/bootstrap-theme-'.Yii::app()->language.'.css?10.3');
    }
    $cs->registerCssFile($baseUrl.'/css/panel.css?10.3');
    if (Yii::app()->params['default_language'] !== Yii::app()->language)
    {
        // @todo add css for multi language
        $cs->registerCssFile($baseUrl.'/css/panel-'.Yii::app()->language.'.css?10.3');
    }
    $cs->registerCssFile($baseUrl.'/css/panel-responsive-theme.css?10.3');
    ...
    $cs->registerScriptFile($baseUrl.'/js/scripts.js?10.3');
    ?>
</head>
