...
/**
 * This is the model class for table "{{class_teacher_rel}}".
 *
 * The followings are the available columns in table '{{class_teacher_rel}}':
 * @property string $teacher_id
 * @property string $class_id
 */
class ClassTeacherRel extends CActiveRecord
{
	/**
	 ...
	 * @return ClassTeacherRel the static model class
	 */
