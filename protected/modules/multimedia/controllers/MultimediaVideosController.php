...
class MultimediaVideosController extends Controller
{
    ...
    {
        return array(
            'checkAccess + create, update, admin, delete, upload, deleteUpload, order, fetch',
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Multimedia'])) {
            ...
            $model->formTags   = isset($_POST['Multimedia']['formTags']) ? explode(',',
                $_POST['Multimedia']['formTags']) : null;
            ...
            if ($model->save()) {
                ...
                Yii::app()->user->setFlash('success',
                    '<span class="icon-check"></span>&nbsp;&nbsp;اطلاعات با موفقیت ذخیره شد.');
