...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		$this->widget('ext.dropZoneUploader.dropZoneUploader', array(
			...
			'maxFiles' => 1,
			'maxFileSize' => 1, //MB
			'url' => Yii::app()->createUrl('/writings/category/upload'),
			'deleteUrl' => Yii::app()->createUrl('/writings/category/deleteUpload'),
	...
	<div class="row">
		...
		$this->widget("ext.tagIt.tagIt",array(
			...
			'attribute' => 'formTags',
			'suggestType' => 'json',
			'suggestUrl' => Yii::app()->createUrl('/writings/tags/list'),
			'data' => $model->formTags
		));
		?>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-body">
				<?
				$this->renderPartial('writings.views.manage._tagForm',array(
					'model' => new ClassTags()
				)); ?>
			</div>
		</div>
