...
?>
	...
	<div class="row">
		...
		$this->widget('ext.dropZoneUploader.dropZoneUploader', array(
			...
			'maxFiles' => 1,
			'maxFileSize' => 1, //MB
			'url' => Yii::app()->createUrl('/writings/manage/upload'),
			'deleteUrl' => Yii::app()->createUrl('/writings/manage/deleteUpload'),
	...
	<div class='row'>
		...
		<?php echo $form->dropDownList($model, 'category_id',WritingCategories::model()->adminSortList()); ?>
